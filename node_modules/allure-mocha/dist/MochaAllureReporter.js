...
const MochaAllureGateway_1 = require("./MochaAllureGateway");
...
let mochaAllure;
const allureGetter = () => mochaAllure;
exports.allureGetter = allureGetter;
exports.allure = new MochaAllureGateway_1.MochaAllureGateway(exports.allureGetter);
class MochaAllureReporter extends Mocha.reporters.Base {
    constructor(runner, opts) {
        ...
        const allureConfig = Object.assign(Object.assign({}, opts.reporterOptions), { resultsDir });
        const runtime = new allure_js_commons_1.AllureRuntime(allureConfig);
        this.coreReporter = new AllureReporter_1.AllureReporter(runtime);
    ...
    onHookEnd(hook) {
        var _a;
        this.coreReporter.endHook((_a = hook === null || hook === void 0 ? void 0 : hook.error) === null || _a === void 0 ? void 0 : _a.call(hook));
    }
}
